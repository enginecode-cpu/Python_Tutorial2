...
print("Ex1-4 -", set(dir(factorial)) - set(dir(A)))
...
class Lotto:
    ...
    def pick(self):
        ...
        return sorted([random.choice(self.balls) for n in range(0, 6)])
...
print("Ex5-5 -", args_test("test1", "test2", "test3", id="admin", password="1234", point=7))
print()
